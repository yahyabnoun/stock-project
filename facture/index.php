...
<body>
  <section>
    <!-- Header -->
    <table width="100%" cellpadding="0" cellspacing="0" class="fullTable center" bgcolor="#e1e1e1">
      <tr>
        <td height="20"></td>
      </tr>
      <tr>
        <td>
          <table width="600" cellpadding="0" cellspacing="0" class="fullTable center" bgcolor="#ffffff"
            ...
            <tr>
              <td>
                <table width="480" cellpadding="0" cellspacing="0" class="fullPadding center">
                  <tbody>
                    <tr>
                      <td>
                        <table width="220" cellpadding="0" cellspacing="0" align="left" class="col">
                          <tbody>
                            <tr>
                              <td align="left">
                                <img src="facture/logo-small.png" width="32" height="32" alt="logo" />
                              </td>
                            </tr>
                            <tr class="hiddenMobile">
                              <td height="40"></td>
